...
namespace Mod_Hub_Base
{
	...
	namespace UI
	{
		static void HEADER_IMPLEMENTATION(INT8 setTypeID);
		...
		static void SET_TEXT_COLOUR1(int red, int green, int blue, int alpha) { invoke<Void>(0xBE6B23FFA53FB442, red, green, blue, alpha); } //
